...
CREATE TABLE [dbo].[RoomAvailiability](
	...
	PRIMARY KEY (RoomID,AvDate), -- joint primary key (NOT RECOMMENDED!), pk can be specified at the end
    FOREIGN KEY (RoomID) REFERENCES Room(RoomID))
GO

ALTER TABLE RoomAvailiability
DROP CONSTRAINT PK__RoomAvai__065EF27D125143E0; -- remove pk after the fact, may be different for you
GO

Alter table RoomAvailiability
add RoomAvailiabilityID int identity primary key; -- add column after the fact
GO
